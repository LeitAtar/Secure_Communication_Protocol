...
- [🧩 How Does the Magic Happen? 🪄](#-how-does-the-magic-happen-)
  - [🖥️ The Client Side (C++17)](#%EF%B8%8F-the-client-side-c17)
...
- [🚀 Features That Make Us Soar](#-features-that-make-us-soar)
  ...
  - [🛡️ File Integrity Checks](#%EF%B8%8F-file-integrity-checks)
  - [⚙️ Robust Error Handling & Reconnection](#%EF%B8%8F-robust-error-handling--reconnection)
- [🎮 Let's Get Started! 🎉](#-lets-get-started-)
  - [🖧 Server Setup](#-server-setup)
  - [🖥️ Client Setup](#%EF%B8%8F-client-setup)
- [🔄 Communication Protocol Codes](#-communication-protocol-codes)
- [🛠️ Technical Marvels](#%EF%B8%8F-technical-marvels)
